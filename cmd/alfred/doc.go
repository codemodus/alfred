// alfred is a CLI application for serving basic html/js/css sites. alfred
// follows an opinionated directory structure and is well-suited to
// prototyping, but should generally not be used for user-facing deployments.
//
//  Available flags:
//
